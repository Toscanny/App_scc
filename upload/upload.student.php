...
?>
    ...
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-4 text-gray-800">Upload Student Sheet</h1>
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <form action="../admin/functions/student.functions.php" method="post" name="file" enctype="multipart/form-data">
